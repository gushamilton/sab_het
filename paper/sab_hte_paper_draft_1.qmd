...
**Parameterization:** Two main parameter sets were used: \* **ARREST Scenario:** Based directly on the Swets et al. [@Swets2024] analysis of the ARREST trial 84-day mortality data. \* `or_vector`: `c(A = 1.0, B = 18.8, C = 0.79, D = 1.4, E = 0.3)` \* `freq_vector`: `c(A = 115/758, B = 107/758, C = 276/758, D = 121/758, E = 139/758)` (overall prevalence across both arms) \* `p0_vector_adjusted`: `c(A = 25/115, B = 0.5/(107+0.5), C = 53/276, D = 22/121, E = 4/139)` (overall mortality across both arms). Note the Haldane-Anscombe correction for subgroup B. \* **Realistic Scenario:** Used more moderate ORs while keeping frequencies and baseline risks the same as the ARREST scenario. \* `or_vector`: `c(A = 1.0, B = 2.0, C = 0.7, D = 1.2, E = 0.8)` \* `freq_vector`: Same as ARREST. \* `p0_vector_adjusted`: Same as ARREST.
