...
all_cases_new <- expand_grid(
  ...
  sens_spec_scenarios,
  target_group = "C", # Focus on subgroup C
...
write_tsv(results_new,
          "results/tables/aim4_closed_form_v2_summary.tsv")

cat("New Aim 4 closed-form results saved to results/tables/aim4_closed_form_v2_summary.tsv\n")
