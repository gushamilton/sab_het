...
all_cases_new <- expand_grid(
  ...
  sens_spec_scenarios,
  target_group = "B", # Focus on subgroup B
...
write_tsv(results_new,
          "results/tables/aim4_closed_form_subgroupB_summary.tsv")

cat("New Aim 4 (Subgroup B) closed-form results saved to results/tables/aim4_closed_form_subgroupB_summary.tsv\n")
