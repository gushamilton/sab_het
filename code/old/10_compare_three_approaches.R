...
#   3) Soft Probabilistic Enrollment: For each patient, their continuous score
#      is their probability of being enrolled. The final analysis is unweighted.
# -----------------------------------------------------------------------------
...
## Design 3: Soft Probabilistic Enrollment
soft_probabilistic_enrollment <- function(pool) {
  enroll_indices <- rbinom(nrow(pool), 1, pool$p) == 1
